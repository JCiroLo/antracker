import { createTheme as createMuiTheme, type Shadows } from "@mui/material";
import Colors from "@/themes/colors";
import type { AccentColor } from "@/types/global";

const createTheme = ({ accentColor }: { accentColor: AccentColor }) =>
  createMuiTheme({
    colorSchemes: {
      dark: {
        palette: {
